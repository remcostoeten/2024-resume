...
export default function ResumeView() {
  ...
  const [pdfUrl] = useState<string>(cfg.RESUME_FILE);
    ...
    return (
      <div className="bg-background text-sm text-foreground antialiased print:m-0 print:bg-white min-h-screen">
        <div className="flex h-screen">
          <div className="hidden lg:flex lg:w-16 lg:flex-col lg:border-r lg:border-border lg:bg-background print:hidden">
            <div className="flex h-16 items-center justify-center">
              <div className="size-6 animate-pulse rounded-md bg-muted" />
            </div>
          </div>
              <div className="relative mx-auto print:m-0" style={{ width: '210mm' }}>
                <iframe
  ...
  return (
    <div className="bg-background text-foreground antialiased print:m-0 print:bg-white min-h-screen flex">
